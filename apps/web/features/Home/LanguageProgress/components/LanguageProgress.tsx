  ...
  if (isLoading) {
    return (
      <div className="max-w-6xl mx-auto">
        <div className="bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl shadow-sm p-12">
      ...
      <div className="relative">
        ...
        {languages.length > 5 && (
          <motion.div
            ...
            className="mt-8 bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl p-6 shadow-sm"
          >
            <div className="text-center">
              <div className="text-base font-medium text-slate-900 dark:text-white mb-3">
